...
/*
 * l'oggetto simulatore dovrà aggiornare lo stato del mondo, modificare i parametri di simulazione e le statistiche raccolte
 * Il simulatore avrà due metodi, uno per inizializzare e uno per elaborare la situazione vera e propria
*/
...
// Parametri di simulazione (dati sulla base dei quali il simulatore decidere come lavorare sugli eventi)
...
// Variabili intere
	...
	public void init(int autoTotali) {
		 ...
		 * arriva un cliente ogni intervalliArrivoCliente
